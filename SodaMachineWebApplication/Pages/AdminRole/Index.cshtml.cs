...
using SodaMachineWebApplication.Data;
using SodaMachineWebApplication.Models;

namespace SodaMachineWebApplication.Pages.AdminRole
{
    public class IndexModel : PageModel
    {
        ...
        public async Task OnGet()
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                IdentityUser adminUser = _context.Users.FirstOrDefault(user => user.Email == adminRoleEmail.UserAdmin);

                if (adminUser == null)
                {
                    string password = adminRoleEmail.UserAdminPassword;
                    IdentityUser identityUser = new IdentityUser
                    {
                        UserName = adminRoleEmail.UserAdmin,
                        Email = adminRoleEmail.UserAdmin,
                        EmailConfirmed = true
                    };
                    ...
                    adminUser = _context.Users.FirstOrDefault(user => user.Email == adminRoleEmail.UserAdmin);
                }
